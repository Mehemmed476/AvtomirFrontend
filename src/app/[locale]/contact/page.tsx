        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-dark-800 p-8 rounded-2xl border border-dark-700 flex items-start gap-4 hover:border-primary/50 transition-colors group">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm mt-2 leading-relaxed">
                    Atatürk prospekti 65a, Bakı<br/>(Gənclik m., Ayna Sultanova istiqaməti)
                  </p>
                </div>
              </div>
              ...
              <div className="bg-dark-800 p-8 rounded-2xl border border-dark-700 flex items-start gap-4 hover:border-primary/50 transition-colors group">
                ...
                <div>
                  ...
                  <a href="tel:0553223066" className="text-2xl font-bold text-white mt-1 hover:text-primary transition-colors block">
                    055 322 30 66
                  </a>
              ...
              <div className="bg-dark-800 p-8 rounded-2xl border border-dark-700 flex items-start gap-4 hover:border-primary/50 transition-colors group">
                ...
                <div>
                  ...
                  <a href="mailto:info@avtomir.az" className="text-gray-400 text-sm mt-2 hover:text-white transition-colors block">
                    info@avtomir.az
                  </a>
                </div>
              </div>
              ...
              <div className="bg-dark-800 p-8 rounded-2xl border border-dark-700 flex items-start gap-4 hover:border-primary/50 transition-colors group">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    Hər gün: <span className="text-white font-medium">10:00 - 22:00</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-dark-800 p-6 rounded-2xl border border-dark-700 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a href="https://instagram.com/avtomir.az" target="_blank" className="flex items-center gap-2 bg-dark-900 px-6 py-3 rounded-xl border border-dark-700 hover:border-primary hover:text-primary transition-all">
                  <Instagram size={20} /> <span className="font-medium">Instagram</span>
                </a>
                <a href="https://facebook.com/avtomir.az" target="_blank" className="flex items-center gap-2 bg-dark-900 px-6 py-3 rounded-xl border border-dark-700 hover:border-primary hover:text-primary transition-all">
                  <Facebook size={20} /> <span className="font-medium">Facebook</span>
                </a>
                <a href="https://wa.me/994553223066" target="_blank" className="flex items-center gap-2 bg-dark-900 px-6 py-3 rounded-xl border border-dark-700 hover:border-green-500 hover:text-green-500 transition-all">
            ...
            <div className="h-[400px] w-full bg-dark-800 rounded-3xl overflow-hidden border border-dark-700 relative shadow-2xl shadow-black/50">
               <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3038.567634668297!2d49.84383181539423!3d40.41634807936523!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4030868995103235%3A0x1a5d1a2965c2a9ee!2sAvtomir.az!5e0!3m2!1sen!2saz!4v1705499999999!5m2!1sen!2saz"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
